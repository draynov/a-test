...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_top,_#f8fafc_0%,_#eef2ff_36%,_#e2e8f0_100%)] px-4 py-10 text-slate-900">
      <div className="mx-auto w-full max-w-6xl space-y-6">
        <header className="overflow-hidden rounded-[2rem] border border-white/70 bg-white/95 p-6 shadow-[0_24px_80px_-24px_rgba(15,23,42,0.24)]">
          ...
          <h1 className="mt-2 text-3xl font-semibold tracking-tight text-slate-950">Вход в системата</h1>
          <p className="mt-2 text-sm text-slate-600">Използвай своя акаунт, за да отвориш работната среда.</p>
        </header>
        ...
        <div className="flex justify-center">
          <div className="w-full max-w-md rounded-[2rem] border border-white/70 bg-white/95 p-8 shadow-[0_24px_80px_-32px_rgba(15,23,42,0.28)] backdrop-blur">
            ...
            <h2 className="mt-2 text-3xl font-semibold tracking-tight text-slate-950">Вход</h2>
            ...
            <p className="mt-6 text-sm text-slate-600">
              Нямаш акаунт?{" "}
              <a href="/register" className="font-semibold text-indigo-700 hover:text-indigo-600">
                Регистрация
              </a>
            </p>
          </div>
